/*******************************************************************************
 * C Structs For Eurex Derivatives T7 Eobi 12.0 Binary Model
 *******************************************************************************/
...
#define ENUM_PRODUCT_COMPLEX_PRODUCT_COMPLEX_MAXIMUM_VALUE 12
...
#define ENUM_TRADE_CONDITION_TRADE_CONDITION_MAXIMUM_VALUE 743
...
#define ENUM_TRD_TYPE_TRD_TYPE_MAXIMUM_VALUE 1017
...
/*
 * Structure: Remaining Order Details Comp
 */ 
typedef struct {
    uint64_t TrdRegTsPrevTimePriority;
    uint64_t DisplayQty;
...
typedef struct {
    ...
    char Pad3[3];
    uint64_t LastPx;
    RemainingOrderDetailsCompT RemainingOrderDetailsComp;
...
/*
 * Structure: Related Instrument Grp Comp
 */ 
typedef struct {
...
/*
 * Structure: Add Scaled Simple Instrument
 */ 
typedef struct {
    int64_t SecurityId;
    uint64_t TransactTime;
    ...
    char Pad4[4];
    RelatedInstrumentGrpCompT RelatedInstrumentGrpComp;
