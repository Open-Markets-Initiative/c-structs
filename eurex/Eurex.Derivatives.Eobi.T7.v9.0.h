/*******************************************************************************
 * C Structs For Eurex Derivatives T7 Eobi 9.0 protocol
 *******************************************************************************/
...
#define ENUM_INSTRUMENT_SCOPE_PRODUCT_COMPLEX_INSTRUMENT_SCOPE_PRODUCT_COMPLEX_MINIMUM_VALUE = 9
...
#define ENUM_MASS_MARKET_CONDITION_MASS_MARKET_CONDITION_MINIMUM_VALUE = 1
...
#define ENUM_MATCH_TYPE_MATCH_TYPE_MINIMUM_VALUE = 14
...
#define ENUM_SECURITY_MASS_STATUS_SECURITY_MASS_STATUS_MINIMUM_VALUE = 12
...
#define ENUM_SECURITY_MASS_TRADING_EVENT_SECURITY_MASS_TRADING_EVENT_MINIMUM_VALUE = 11
...
Protocol:
   ...
   Specification: T7_EOBI_Manual_v.9.0.0.pdf
