...
#define ENUM_LAST_MKT_LAST_MKT_MINIMUM_VALUE = 255
...
#define ENUM_QUOTE_EVENT_REASON_QUOTE_EVENT_REASON_MINIMUM_VALUE = 17
...
#define ENUM_RFQ_PUBLISH_INDICATOR_RFQ_PUBLISH_INDICATOR_MINIMUM_VALUE = 5
...
#define ENUM_RFQ_REQUESTER_DISCLOSURE_INSTRUCTION_RFQ_REQUESTER_DISCLOSURE_INSTRUCTION_MINIMUM_VALUE = 1
...
#define ENUM_VALUE_CHECK_TYPE_QUANTITY_VALUE_CHECK_TYPE_QUANTITY_MINIMUM_VALUE = 1
