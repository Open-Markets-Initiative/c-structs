/*******************************************************************************
 * C Structs For Eurex Cash T7 Eti 5.0 protocol
 *******************************************************************************/
...
#define ENUM_APPL_ID_APPL_ID_MINIMUM_VALUE = 8
...
#define ENUM_CROSSED_CROSSED_MINIMUM_VALUE = 1
...
#define ENUM_DELIVERY_TYPE_DELIVERY_TYPE_MINIMUM_VALUE = 4
...
#define ENUM_EXEC_RESTATEMENT_REASON_MARKED_FOR_DELETION = 244
...
#define ENUM_EXEC_RESTATEMENT_REASON_INITIAL_CLEANUP = 257
...
#define ENUM_EXEC_RESTATEMENT_REASON_EXEC_RESTATEMENT_REASON_MINIMUM_VALUE = 299
...
#define ENUM_REF_APPL_ID_REF_APPL_ID_MINIMUM_VALUE = 8
...
#define ENUM_STOP_PX_INDICATOR_STOP_PX_INDICATOR_MINIMUM_VALUE = 1
...
#define ENUM_TRADING_CAPACITY_TRADING_CAPACITY_MINIMUM_VALUE = 6
