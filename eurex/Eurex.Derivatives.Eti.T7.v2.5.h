...
#define ENUM_AGGRESSOR_INDICATOR_AGGRESSOR_INDICATOR_MINIMUM_VALUE = 1
#define ENUM_AGGRESSOR_INDICATOR_AGGRESSOR_INDICATOR_MINIMUM_VALUE = 0
...
#define ENUM_APPL_ID_APPL_ID_MINIMUM_VALUE = 6
...
#define ENUM_QUOTE_EVENT_REASON_QUOTE_EVENT_REASON_MINIMUM_VALUE = 15
...
#define ENUM_REF_APPL_ID_REF_APPL_ID_MINIMUM_VALUE = 6
...
#define ENUM_TRADE_REPORT_TYPE_TRADE_REPORT_TYPE_MINIMUM_VALUE = 7
...
#define ENUM_USER_STATUS_USER_STATUS_MINIMUM_VALUE = 10
