/*******************************************************************************
 * C Structs For Eurex Derivatives T7 Eti 11.1 Binary Model
 *******************************************************************************/
...
#define ENUM_RELATED_PRODUCT_COMPLEX_RELATED_PRODUCT_COMPLEX_MAXIMUM_VALUE 11
...
#define ENUM_TRD_TYPE_TRD_TYPE_MAXIMUM_VALUE 1011
...
typedef struct {
    ...
    char ComplianceText[20];
    char PartyIdTakeUpTradingFirm[5];
    char PartyEndClientIdentification[5];
    char Pad5[5];
