/*******************************************************************************
 * C Structs For Nasdaq Bx Equities Ouch Orders 4.2 Binary Model
 *******************************************************************************/
...
#define ENUM_DISPLAY_RETAIL_ORDER_TYPE_1 'O'
#define ENUM_DISPLAY_RETAIL_ORDER_TYPE_2 'T'
#define ENUM_DISPLAY_RETAIL_PRICE_IMPROVEMENT_ORDER 'Q'
...
#define ENUM_LIQUIDITY_FLAG_RPI 'j'
#define ENUM_LIQUIDITY_FLAG_RMO_RETAIL_ORDER_REMOVES_RPI_LIQUIDITY 'r'
#define ENUM_LIQUIDITY_FLAG_RMO_RETAIL_ORDER_REMOVES_PRICE_IMPROVING_NONDISPLAYED_LIQUIDITY_OTHER_THAN_RPI_LIQUIDITY 't'
...
#define ENUM_LIQUIDITY_FLAG_DISPLAYED_LIQUIDITYADDING_ORDER_SETS_THE_BXBBO_WHILE_JOINING_THE_NBBO '8'
...
#define ENUM_REJECTED_REASON_NASDAQ_OMX_BX_IS_CLOSED 'C'
...
#define ENUM_REJECTED_REASON_MIDPOINT_PEG_ORDERS_ARE_NOT_ACCEPTED 'q'
