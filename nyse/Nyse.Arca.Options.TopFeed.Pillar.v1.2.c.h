/*******************************************************************************
 * C Structs For Nyse Arca Options Pillar TopFeed 1.2.c Binary Model
 *******************************************************************************/
 ...
 */ 
#define ENUM_AUCTION_STATUS_USUAL 0
#define ENUM_AUCTION_STATUS_LEGAL_WIDTH_QUOTE_DOES_NOT_EXIST 4
#define ENUM_AUCTION_STATUS_MARKET_MAKER_QUOTE_IS_NOT_RECEIVED 5
...
#define ENUM_MESSAGE_TYPE_OPTIONS_TRADE_CANCEL_MESSAGE 322
#define ENUM_MESSAGE_TYPE_OPTIONS_TRADE_CORRECTION_MESSAGE 322
#define ENUM_MESSAGE_TYPE_OPTIONS_IMBALANCE_MESSAGE 305
#define ENUM_MESSAGE_TYPE_SERIES_RFQ_MESSAGE 307
#define ENUM_MESSAGE_TYPE_OUTRIGHT_SERIES_SUMMARY_MESSAGE 323

/*
 * Opening Values
 */ 
#define ENUM_OPENING_NONE ' '
#define ENUM_OPENING_MARKET_CENTER_OPENING_TRADE 'O'
#define ENUM_OPENING_REOPENING_TRADE '5'
 ...
 * Transaction Values
 */ 
#define ENUM_TRANSACTION_OPENING_TRADE_IN_SEQUENCE 'H'
#define ENUM_TRANSACTION_OPENING_TRADE_OUT_OF_SEQUENCE 'F'
#define ENUM_TRANSACTION_IN_SEQUENCE 'D'
#define ENUM_TRANSACTION_OUT_OF_SEQUENCE 'B'
...
/*
 * Structure: Outright Series Summary Message
 */ 
typedef struct {
    uint32_t SourceTime;
...
/*
 * Structure: Options Imbalance Message
 */ 
typedef struct {
    uint32_t SourceTime;
    uint32_t SourceTimeNs;
...
} OptionsImbalanceMessageT;

/*
 * Structure: Correction Condition
 */ 
typedef struct {
    char Transaction;
    char Reserved3[3];
} CorrectionConditionT;

/*
 * Structure: Options Trade Correction Message
 */ 
typedef struct {
    uint32_t SourceTime;
    uint32_t SourceTimeNs;
    ...
    int32_t Price;
    uint32_t Volume;
    CorrectionConditionT CorrectionCondition;
} OptionsTradeCorrectionMessageT;
