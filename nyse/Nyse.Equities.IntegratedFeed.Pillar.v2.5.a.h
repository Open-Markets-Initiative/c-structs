/*******************************************************************************
 * C Structs For Nyse Equities Pillar IntegratedFeed 2.5.a Binary Model
 *******************************************************************************/
 ...
 */ 
#define ENUM_AUCTION_STATUS_WILL_RUN_AS_ALWAYS_FOR_OPEN_AND_CLOSE 0
#define ENUM_AUCTION_STATUS_WILL_RUN_INTEREST_EXISTS_INSIDE_OR_AT_THE_COLLARS_OR_IS_FULLY_PAIRED_OFF 1
#define ENUM_AUCTION_STATUS_WILL_NOT_RUN_BECAUSE_THERE_IS_AN_IMBALANCE_THROUGH_THE_COLLARS 2
#define ENUM_AUCTION_STATUS_WILL_NOT_RUN_WILL_TRANSITION_TO_THE_CLOSING_AUCTION_INSTEAD 3

/*
 * Auction Type Values
 */ 
#define ENUM_AUCTION_TYPE_EARLY_OPENING_AUCTION_NON_NYSE_ONLY 'O'
#define ENUM_AUCTION_TYPE_CORE_OPENING_AUCTION 'M'
#define ENUM_AUCTION_TYPE_REOPENING_AUCTION_HALT_RESUME 'H'
#define ENUM_AUCTION_TYPE_CLOSING_AUCTION 'C'
#define ENUM_AUCTION_TYPE_EXTREME_CLOSING_IMBALANCE 'P'
#define ENUM_AUCTION_TYPE_REGULATORY_CLOSING_IMBALANCE 'R'

/*
 * Cross Type Values
 */ 
#define ENUM_CROSS_TYPE_MARKET_CENTER_EARLY_OPENING_AUCTION 'E'
#define ENUM_CROSS_TYPE_MARKET_CENTER_OPENING_AUCTION 'O'
#define ENUM_CROSS_TYPE_MARKET_CENTER_REOPENING_AUCTION '5'
#define ENUM_CROSS_TYPE_MARKET_CENTER_CLOSING_AUCTION '6'

/*
 * Delivery Flag Values
 */ 
#define ENUM_DELIVERY_FLAG_HEARTBEAT 1
#define ENUM_DELIVERY_FLAG_FAILOVER 10
 ...
 */ 
#define ENUM_FREEZE_STATUS_IMBALANCE_FREEZE_NOT_IN_EFFECT 0
#define ENUM_FREEZE_STATUS_IMBALANCE_FREEZE_IS_IN_EFFECT 1
...
#define ENUM_MARKET_ID_NYSE_CHICAGO 11
...
#define ENUM_RPI_INDICATOR_RETAIL_INTEREST_ON_THE_BID_SIDE 'A'
#define ENUM_RPI_INDICATOR_RETAIL_INTEREST_ON_THE_OFFER_SIDE 'B'
#define ENUM_RPI_INDICATOR_RETAIL_INTEREST_ON_THE_BID_AND_OFFER_SIDES 'C'
 ...
 */ 
#define ENUM_SIGNIFICANT_IMBALANCE_DEFAULT ' '
#define ENUM_SIGNIFICANT_IMBALANCE_THE_CURRENT_IMBALANCE_IS_SIGNIFICANT 'Y'
...
#define ENUM_SSR_TRIGGERING_EXCHANGE_ID_MIAMI_PEARL 'H'
#define ENUM_SSR_TRIGGERING_EXCHANGE_ID_NASDAQ_ISE 'I'
#define ENUM_SSR_TRIGGERING_EXCHANGE_ID_CBOE_EDGA 'J'
...
#define ENUM_STATUS_INVALID_MSG_TYPE_OR_MSG_SIZE_MISMATCH '9'

/*
 * Trade Cond 1 Values
 */ 
#define ENUM_TRADE_COND_1_REGULAR_SALE '@'
#define ENUM_TRADE_COND_1_CASH 'C'
#define ENUM_TRADE_COND_1_NEXT_DAY_TRADE 'N'

/*
 * Trade Cond 2 Values
 */ 
#define ENUM_TRADE_COND_2_NOT_AVAILABLE ' '
#define ENUM_TRADE_COND_2_INTERMARKET_SWEEP_ORDER 'F'
#define ENUM_TRADE_COND_2_MARKET_CENTER_OPENING_TRADE 'O'
#define ENUM_TRADE_COND_2_REOPENING_TRADE '5'
#define ENUM_TRADE_COND_2_MARKET_CENTER_CLOSING_TRADE '6'
#define ENUM_TRADE_COND_2_QUALIFIED_CONTINGENT_TRADE '7'

/*
 * Trade Cond 3 Values
 */ 
#define ENUM_TRADE_COND_3_NOT_AVAILABLE ' '
#define ENUM_TRADE_COND_3_EXTENDED_HOURS_TRADE 'T'
#define ENUM_TRADE_COND_3_EXTENDED_HOURS_SOLD 'U'
#define ENUM_TRADE_COND_3_SOLD 'Z'

/*
 * Trade Cond 4 Values
 */ 
#define ENUM_TRADE_COND_4_NOT_AVAILABLE ' '
#define ENUM_TRADE_COND_4_ODD_LOT_TRADE 'I'
#define ENUM_TRADE_COND_4_CONTINGENT_TRADE 'V'

/*
 * Unpaired Side Values
 */ 
#define ENUM_UNPAIRED_SIDE_NOT_APPLICABLE ' '
#define ENUM_UNPAIRED_SIDE_BUY_SIDE 'B'
#define ENUM_UNPAIRED_SIDE_SELL_SIDE 'S'
