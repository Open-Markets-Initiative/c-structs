/*******************************************************************************
 * C Structs For Cboe Equities Edgx Boe OrderEntry 2.3 protocol
 *******************************************************************************/
...
#define ENUM_EX_DESTINATION_BZX_Y = 'Y'
...
#define ENUM_EXEC_INST_MIDPOINT_DISCRETIONARY_ORDER_D = 'd'
...
#define ENUM_EXT_EXEC_INST_RETAIL_PRIORITY_ORDER_X = 'X'
