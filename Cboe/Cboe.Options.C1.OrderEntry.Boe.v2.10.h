...
#define ENUM_CAPACITY_NON_TRADING_PERMIT_HOLDER_AFFILIATE_L = 'L'

/*
 * Combo Order Values
 */ 
#define ENUM_COMBO_ORDER_NO_N = 'N'
#define ENUM_COMBO_ORDER_YES_Y = 'Y'

/*
 * Compression Values
 */ 
#define ENUM_COMPRESSION_NO_N = 'N'
#define ENUM_COMPRESSION_YES_Y = 'Y'
 ...
 * Exec Inst Values
 */ 
#define ENUM_EXEC_INST_NOT_HELD_1 = '1'
#define ENUM_EXEC_INST_INTERMARKET_SWEEP_F = 'f'
#define ENUM_EXEC_INST_SETTLEMENT_LIQUIDITY_R = 'r'
 ...
 */ 
#define ENUM_FLOOR_ROUTING_INST_DIRECT_D = 'D'
#define ENUM_FLOOR_ROUTING_INST_ELECTRONIC_ONLY_E = 'E'
#define ENUM_FLOOR_ROUTING_INST_ROUTE_TO_FLOOR_IF_NOT_ELECTRONIC_X = 'X'
...
#define ENUM_MESSAGE_TYPE_ADD_FLOOR_TRADE_MESSAGE_0X_5C = 0x5C
#define ENUM_MESSAGE_TYPE_FLOOR_TRADE_CONFIRMATION_MESSAGE_0X_5B = 0x5B
#define ENUM_MESSAGE_TYPE_DELETE_FLOOR_TRADE_MESSAGE_0X_5D = 0x5D
...
#define ENUM_MESSAGE_TYPE_FLOOR_TRADE_NOTIFICATION_MESSAGE_0X62 = 0x62
#define ENUM_MESSAGE_TYPE_ADD_FLOOR_TRADE_REJECTED_MESSAGE_0X_5F = 0x5F
#define ENUM_MESSAGE_TYPE_FLOOR_TRADE_CONFIRMATION_REJECTED_MESSAGE_0X_5E = 0x5E
#define ENUM_MESSAGE_TYPE_DELETE_FLOOR_TRADE_REJECTED_MESSAGE_0X60 = 0x60
 ...
 */ 
#define ENUM_MULTILEG_REPORTING_TYPE_SINGLE_LEG_INSTRUMENT_1 = '1'
#define ENUM_MULTILEG_REPORTING_TYPE_INDIVIDUAL_LEG_OF_MULTILEG_INSTRUMENT_2 = '2'
#define ENUM_MULTILEG_REPORTING_TYPE_ENTIRE_MULTILEG_PACKAGE_3 = '3'
...
#define ENUM_QUOTE_RESULT_NO_CHANGE_EXISTING_CONSTITUENT_SERIES_QUOTE_MODIFY_V = 'V'
...
#define ENUM_QUOTE_RESULT_REJECTED_ATTEMPT_TO_ADD_CONSTITUENT_SERIES_QUOTE_AFTER_CUTOFF_TIME_V = 'v'

/*
 * Restatement Reason Values
 */ 
#define ENUM_RESTATEMENT_REASON_REDUCTION_OF_ORD_QTY_DUE_TO_EQUITY_LEG_REJECT_E = 'E'
#define ENUM_RESTATEMENT_REASON_REPRESENTED_ON_FLOOR_F = 'F'
 ...
 */ 
#define ENUM_TRADE_THROUGH_ALERT_TYPE_NO_TRADE_THROUGH_0 = '0'
#define ENUM_TRADE_THROUGH_ALERT_TYPE_NBBO_1 = '1'
#define ENUM_TRADE_THROUGH_ALERT_TYPE_BBO_2 = '2'
#define ENUM_TRADE_THROUGH_ALERT_TYPE_SBBO_3 = '3'
#define ENUM_TRADE_THROUGH_ALERT_TYPE_BOOK_TRADE_THROUGH_4 = '4'
#define ENUM_TRADE_THROUGH_ALERT_TYPE_DUE_DILIGENCE_TRADE_THROUGH_5 = '5'
...
typedef struct {
    ...
    char CrossOrderAcknowledgmentReservedBit6Exists[1];
    char CrossOrderAcknowledgmentReservedBit5Exists[1];
    char CrossOrderAcknowledgmentCompressionExists[1];
    char CrossOrderAcknowledgmentReservedBit3Exists[1];
    char CrossOrderAcknowledgmentReservedBit2Exists[1];
...
typedef struct {
    ...
    char CrossOrderCancelledReservedBit6Exists[1];
    char CrossOrderCancelledReservedBit5Exists[1];
    char CrossOrderCancelledCompressionExists[1];
    char CrossOrderCancelledReservedBit3Exists[1];
    char CrossOrderCancelledReservedBit2Exists[1];
...
typedef struct {
    ...
    char CrossOrderRejectedReservedBit6Exists[1];
    char CrossOrderRejectedReservedBit5Exists[1];
    char CrossOrderRejectedCompressionExists[1];
    char CrossOrderRejectedReservedBit3Exists[1];
    char CrossOrderRejectedReservedBit2Exists[1];
 ...
 */ 
typedef struct {
    char NewOrderFloorRoutingInstExists[1];
    char NewOrderFloorDestinationExists[1];
    char NewOrderCompressionExists[1];
...
typedef struct {
    ...
    char NewOrderCrossCompressionExists[1];
} NewOrderCrossByte4T;
 ...
 */ 
typedef struct {
    char NewOrderCrossMultilegCompressionExists[1];
...
typedef struct {
    ...
    char OrderAcknowledgmentFloorDestinationExists[1];
    char OrderAcknowledgmentCompressionExists[1];
    char OrderAcknowledgmentComboOrderExists[1];
...
typedef struct {
    ...
    char OrderCancelledFloorDestinationExists[1];
    char OrderCancelledCompressionExists[1];
    char OrderCancelledComboOrderExists[1];
    char OrderCancelledReservedBit2Exists[1];
...
typedef struct {
    ...
    char OrderExecutionFloorDestinationExists[1];
    char OrderExecutionCompressionExists[1];
    char OrderExecutionComboOrderExists[1];
    char OrderExecutionReservedBit2Exists[1];
...
typedef struct {
    ...
    char OrderModifiedFloorDestinationExists[1];
    char OrderModifiedCompressionExists[1];
    char OrderModifiedComboOrderExists[1];
...
typedef struct {
    ...
    char OrderRejectedFloorDestinationExists[1];
    char OrderRejectedCompressionExists[1];
    char OrderRejectedComboOrderExists[1];
...
typedef struct {
    ...
    char OrderRestatedFloorDestinationExists[1];
    char OrderRestatedCompressionExists[1];
    char OrderRestatedComboOrderExists[1];
    char OrderRestatedReservedBit2Exists[1];
