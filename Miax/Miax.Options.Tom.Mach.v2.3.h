...
#define ENUM_TRADE_CONDITION_PAIRED_PRIME_A = 'a'
#define ENUM_TRADE_CONDITION_RESERVED_B = 'b'
#define ENUM_TRADE_CONDITION_PRIME_CUSTOMER_TO_CUSTOMER_CROSS_OR_PRIME_QCC_C = 'c'
#define ENUM_TRADE_CONDITION_RESERVED_D = 'd'
#define ENUM_TRADE_CONDITION_RESERVED_E = 'e'
#define ENUM_TRADE_CONDITION_COMPLEX_TRANSACTION_THAT_IS_NOT_COMPLEX_STOCKTIED_AND_DOES_NOT_INVOLVE_LEGGING_F = 'f'
#define ENUM_TRADE_CONDITION_COMPLEX_PRIME_TRANSACTION_THAT_IS_NOT_COMPLEX_STOCKTIED_AND_DOES_NOT_INVOLVE_LEGGING_G = 'g'
#define ENUM_TRADE_CONDITION_COMPLEX_PRIME_CUSTOMER_TO_CUSTOMER_CROSS_OR_COMPLEX_PRIME_QCC_TRANSACTION_THAT_IS_NOT_COMPLEX_STOCKTIED_H = 'h'
#define ENUM_TRADE_CONDITION_RESERVED_I = 'i'
#define ENUM_TRADE_CONDITION_COMPLEX_LEGGING_TRANSACTION_THAT_IS_NOT_COMPLEX_STOCKTIED_J = 'j'
#define ENUM_TRADE_CONDITION_COMPLEX_PRIME_STOCKTIED_TRANSACTION_THAT_DOES_NOT_INVOLVE_LEGGING_K = 'k'
#define ENUM_TRADE_CONDITION_COMPLEX_PRIME_LEGGING_TRANSACTION_THAT_IS_NOT_COMPLEX_STOCKTIED_L = 'l'
#define ENUM_TRADE_CONDITION_RESERVED_M = 'm'
#define ENUM_TRADE_CONDITION_COMPLEX_STOCKTIED_TRANSACTION_THAT_DOES_NOT_INVOLVE_LEGGING_N = 'n'
#define ENUM_TRADE_CONDITION_COMPLEX_CUSTOMER_TO_CUSTOMER_CROSS_STOCKTIED_OR_COMPLEX_QCC_STOCKTIED_TRANSACTION_O = 'o'
#define ENUM_TRADE_CONDITION_RESERVED_P = 'p'
#define ENUM_TRADE_CONDITION_RESERVED_Q = 'q'
#define ENUM_TRADE_CONDITION_RESERVED_R = 'r'
#define ENUM_TRADE_CONDITION_RESERVED_S = 's'
#define ENUM_TRADE_CONDITION_RESERVED_T = 't'
