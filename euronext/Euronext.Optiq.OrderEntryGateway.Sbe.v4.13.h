/*******************************************************************************
 * C Structs For Euronext Optiq Sbe OrderEntryGateway 4.13 Binary Model
 *******************************************************************************/
...
Protocol:
   ...
   Specification: Euronext Derivatives Markets – Optiq Kinematics Specifications - v4.13.0 +TC.pdf
