/*******************************************************************************
 * C Structs For Ice Futures iMpact Mdf 1.1.43 Binary Model
 *******************************************************************************/
 ...
 * Endex Status Values
 */ 
#define ENUM_ENDEX_STATUS_CURRENT 'C'
#define ENUM_ENDEX_STATUS_DEFAULT 'D'
#define ENUM_ENDEX_STATUS_FINAL 'F'
#define ENUM_ENDEX_STATUS_NON_ENDEX_SPOT_MARKET ''
 ...
 * Event Type Values
 */ 
#define ENUM_EVENT_TYPE_IMPLICATION_DISABLED_FOR_THE_MARKET 'A'
 ...
 */ 
#define ENUM_FIXING_STATUS_CLOSED 'C'
#define ENUM_FIXING_STATUS_PREOPEN 'P'
#define ENUM_FIXING_STATUS_LOCKDOWN 'L'

/*
 * Flex Allowed Values
 */ 
#define ENUM_FLEX_ALLOWED_YES 'Y'
#define ENUM_FLEX_ALLOWED_NO 'N'
 ...
 * Is Implied Values
 */ 
#define ENUM_IS_IMPLIED_YES 'Y'
#define ENUM_IS_IMPLIED_NO 'N'
 ...
 * Is Rfq Values
 */ 
#define ENUM_IS_RFQ_YES 'Y'
#define ENUM_IS_RFQ_NO 'N'
 ...
 */ 
#define ENUM_IS_TRANSACTION_END_YES 'Y'
#define ENUM_IS_TRANSACTION_END_NO 'N'
...
#define ENUM_MESSAGE_TYPE_FRAGMENT_WRAPPER_MESSAGE 'Z'
...
#define ENUM_MESSAGE_TYPE_FIXING_INDICATIVE_PRICE_MESSAGE '0'
...
typedef struct {
    ...
    char IsTradable;
    int16_t OldNumOfCycles;
    int16_t MarketTypeId;
    int32_t NumOfCycles;
} NewOptionsMarketDefinitionMessageT;

/*
 * Structure: Extra Strategy Leg Definition
 */ 
typedef struct {
    int8_t LegBodyLength;
    int32_t LegMarketId;
    int32_t LegUnderlyingMarketId;
...
} ExtraStrategyLegDefinitionT;

/*
 * Structure: Hedge Definition
 */ 
typedef struct {
    int8_t HedgeBodyLength;
    int32_t HedgeMarketId;
    char HedgeSecurityType[1];
    char HedgeSide;
    int64_t HedgePrice;
    char HedgePriceDenominator[1];
    int16_t HedgeDeltaObsolete;
    int16_t HedgeStrategyCode;
    int32_t HedgeDelta;
} HedgeDefinitionT;
...
/*
 * Structure: Fixing Indicative Price Message
 */ 
typedef struct {
    int32_t MarketId;
    char IbaCurrency[3];
...
/*
 * Structure: Fragment Wrapper Message
 */ 
typedef struct {
    int16_t TotalLength;
    int16_t FragmentOffset;
    int16_t FragmentLength;
    char FragmentBytes[0];
} FragmentWrapperMessageT;
...
/*
 * Structure: Extra Leg Definition
 */ 
typedef struct {
    int8_t LegBodyLength;
    int32_t LegMarketId;
