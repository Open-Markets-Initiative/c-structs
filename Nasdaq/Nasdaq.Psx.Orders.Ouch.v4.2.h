/*******************************************************************************
 * C Structs For Nasdaq Psx Ouch Orders 4.2 protocol
 *******************************************************************************/
...
#define ENUM_LIQUIDITY_FLAG_OPENING_O = 'O'
#define ENUM_LIQUIDITY_FLAG_OPENING_CROSS_M = 'M'
#define ENUM_LIQUIDITY_FLAG_CLOSING_C = 'C'
#define ENUM_LIQUIDITY_FLAG_CLOSING_CROSS_L = 'L'
#define ENUM_LIQUIDITY_FLAG_HALT_IPO_H = 'H'
#define ENUM_LIQUIDITY_FLAG_HALT_K = 'K'
#define ENUM_LIQUIDITY_FLAG_NONDISPLAYED_J = 'J'
#define ENUM_LIQUIDITY_FLAG_REMOVED_M = 'm'
#define ENUM_LIQUIDITY_FLAG_ADDED_K = 'k'
#define ENUM_LIQUIDITY_FLAG_DISPLAYED_ADDED_LIQUIDITY_V = 'V'
...
#define ENUM_REJECTED_REASON_NASDAQ_OMX_PSX_IS_CLOSED_C = 'C'
