...
#define ENUM_CURRENT_TRADING_STATE_BUY_SIDE_TRADING_SUSPENDED_EXHAUSTED_B = 'B'
#define ENUM_CURRENT_TRADING_STATE_SELL_SIDE_TRADING_SUSPENDED_EXHAUSTED_S = 'S'
...
#define ENUM_MARKET_SIDE_BUY_A = 'A'
#define ENUM_MARKET_SIDE_SELL_B = 'B'
...
#define ENUM_MESSAGE_TYPE_ORDER_REPLACE_MESSAGE_SHORT_FORM_V = 'v'
#define ENUM_MESSAGE_TYPE_SINGLE_SIDE_REPLACE_LONG_FORM_MESSAGE_V = 'V'
#define ENUM_MESSAGE_TYPE_SINGLE_SIDE_DELETE_MESSAGE_D = 'D'
#define ENUM_MESSAGE_TYPE_SINGLE_SIDE_UPDATE_MESSAGE_G = 'G'
#define ENUM_MESSAGE_TYPE_QUOTE_REPLACE_SHORT_FORM_MESSAGE_K = 'k'
#define ENUM_MESSAGE_TYPE_QUOTE_REPLACE_LONG_FORM_MESSAGE_K = 'K'
...
#define ENUM_MESSAGE_TYPE_BROKEN_TRADE_ORDER_EXECUTION_MESSAGE_B = 'B'
