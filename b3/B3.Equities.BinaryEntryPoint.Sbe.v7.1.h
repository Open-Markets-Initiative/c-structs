/*******************************************************************************
 * C Structs For B3 Equities Sbe BinaryEntryPoint 7.1 Binary Model
 *******************************************************************************/
...
#define ENUM_MASS_ACTION_TYPE_SESSIONGROUPQUERY 5
...
#define ENUM_SELF_TRADE_PREVENTION_INSTRUCTION_NO_VALUE 0
...
typedef struct {
    ...
    uint32_t ActionTargetSessionId;
    uint32_t ActionTargetGroupId;
...
typedef struct {
    ...
    uint8_t ExecRestatementReason;
    uint32_t ActionRequestedFromSessionId;
...
/*
 * Structure: Deprecated Investor Id
 */ 
typedef struct {
    uint8_t Length;
    char VarData[0];
} DeprecatedInvestorIdT;
...
typedef struct {
    ...
    DeprecatedInvestorIdT DeprecatedInvestorId;
    DeskIdT DeskId;
    MemoT Memo;
