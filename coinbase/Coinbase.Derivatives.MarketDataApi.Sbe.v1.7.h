/*******************************************************************************
 * C Structs For Coinbase Derivatives Sbe MarketDataApi 1.7 protocol
 *******************************************************************************/
...
/*
 * Option Expiry Type Values
 */ 
#define ENUM_OPTION_EXPIRY_TYPE_WEEKLY = 0
#define ENUM_OPTION_EXPIRY_TYPE_MONTHLY = 1
...
#define ENUM_PRODUCT_GROUP_CRYPTO = 6
...
#define ENUM_TEMPLATE_ID_END_OF_CYCLE_MESSAGE = 124
...
/*
 * Structure: End Of Cycle Message
 */ 
typedef struct {
    int32_t ActiveInstrumentCount;
} EndOfCycleMessageT;
...
typedef struct {
    ...
    DefinitionFlagsT DefinitionFlags;
    int8_t OptionExpiryType;
    LogicalExpiryT LogicalExpiry;
...
typedef struct {
    ...
    EndOfCycleMessageT EndOfCycleMessage;
