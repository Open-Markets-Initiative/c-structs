/*******************************************************************************
 * C Structs For Cme Futures Sbe Mdp3 1.13 Binary Model
 *******************************************************************************/
...
#define ENUM_HALT_REASON_TRADE_DATE_ROLL 7
...
#define ENUM_MD_ENTRY_TYPE_MARKET_BEST_OFFER 'w'
#define ENUM_MD_ENTRY_TYPE_MARKET_BEST_BID 'x'
...
#define ENUM_MD_ENTRY_TYPE_BOOK_MARKET_BEST_OFFER 'w'
#define ENUM_MD_ENTRY_TYPE_BOOK_MARKET_BEST_BID 'x'
...
#define ENUM_TEMPLATE_ID_MD_INSTRUMENT_DEFINITION_FX 63
#define ENUM_TEMPLATE_ID_MD_INCREMENTAL_REFRESH_BOOK_LONG_QTY 64
#define ENUM_TEMPLATE_ID_MD_INCREMENTAL_REFRESH_TRADE_SUMMARY_LONG_QTY 65
#define ENUM_TEMPLATE_ID_MD_INCREMENTAL_REFRESH_VOLUME_LONG_QTY 66
#define ENUM_TEMPLATE_ID_MD_INCREMENTAL_REFRESH_SESSION_STATISTICS_LONG_QTY 67
#define ENUM_TEMPLATE_ID_SNAPSHOT_FULL_REFRESH_TCP_LONG_QTY 68
#define ENUM_TEMPLATE_ID_SNAPSHOT_FULL_REFRESH_LONG_QTY 69
...
typedef struct {
    ...
    uint64_t MdEntrySizeUInt64Null;
    int32_t NumberOfOrdersOptional;
    uint8_t MdPriceLevelUInt8Null;
    uint8_t OpenCloseSettlFlag;
    char MdEntryType;
} SnapshotFullRefreshLongQtyGroupT;
...
/*
 * Structure: Snapshot Full Refresh Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} SnapshotFullRefreshLongQtyGroupsT;

/*
 * Structure: Snapshot Full Refresh Long Qty
 */ 
typedef struct {
...
} SnapshotFullRefreshLongQtyT;

/*
 * Structure: Snapshot Full Refresh Tc P Long Qty Group
 */ 
typedef struct {
    int64_t MdEntryPxOptional;
    uint64_t MdEntrySizeUInt64Null;
    ...
    uint8_t OpenCloseSettlFlag;
    char MdEntryType;
} SnapshotFullRefreshTcPLongQtyGroupT;

/*
 * Structure: Snapshot Full Refresh Tc P Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} SnapshotFullRefreshTcPLongQtyGroupsT;
...
/*
 * Structure: Snapshot Full Refresh Tcp Long Qty
 */ 
typedef struct {
    uint64_t TransactTime;
    ...
    int64_t LowLimitPrice;
    int64_t MaxPriceVariation;
} SnapshotFullRefreshTcpLongQtyT;

/*
 * Structure: M D Incremental Refresh Session Statistics Long Qty Group
 */ 
typedef struct {
    int64_t MdEntryPx;
    uint64_t MdEntrySizeUInt64Null;
    ...
    char Padding5[5];
} MDIncrementalRefreshSessionStatisticsLongQtyGroupT;

/*
 * Structure: M D Incremental Refresh Session Statistics Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} MDIncrementalRefreshSessionStatisticsLongQtyGroupsT;

/*
 * Structure: Md Incremental Refresh Session Statistics Long Qty
 */ 
typedef struct {
    uint64_t TransactTime;
    MatchEventIndicatorT MatchEventIndicator;
    char Padding2[2];
} MdIncrementalRefreshSessionStatisticsLongQtyT;

/*
 * Structure: M D Incremental Refresh Volume Long Qty Group
 */ 
typedef struct {
    uint64_t MdEntrySizeUInt64;
    int32_t SecurityId;
    uint32_t RptSeq;
    uint8_t MdUpdateAction;
    char Padding7[7];
} MDIncrementalRefreshVolumeLongQtyGroupT;

/*
 * Structure: M D Incremental Refresh Volume Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} MDIncrementalRefreshVolumeLongQtyGroupsT;

/*
 * Structure: Md Incremental Refresh Volume Long Qty
 */ 
typedef struct {
    uint64_t TransactTime;
    MatchEventIndicatorT MatchEventIndicator;
    char Padding2[2];
} MdIncrementalRefreshVolumeLongQtyT;

/*
 * Structure: M D Incremental Refresh Trade Summary Long Qty Order Group
 */ 
typedef struct {
    uint64_t OrderId;
    int32_t LastQty;
    char Padding4[4];
} MDIncrementalRefreshTradeSummaryLongQtyOrderGroupT;
...
/*
 * Structure: M D Incremental Refresh Trade Summary Long Qty Order Groups
 */ 
typedef struct {
    GroupSize8ByteT GroupSize8Byte;
} MDIncrementalRefreshTradeSummaryLongQtyOrderGroupsT;

/*
 * Structure: M D Incremental Refresh Trade Summary Long Qty Group
 */ 
typedef struct {
    int64_t MdEntryPx;
    uint64_t MdEntrySizeUInt64;
    ...
    uint32_t MdTradeEntryIDUInt32;
    uint8_t AggressorSide;
    uint8_t MdUpdateAction;
    char Padding6[6];
} MDIncrementalRefreshTradeSummaryLongQtyGroupT;

/*
 * Structure: M D Incremental Refresh Trade Summary Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} MDIncrementalRefreshTradeSummaryLongQtyGroupsT;

/*
 * Structure: M D Incremental Refresh Book Long Qty Order Group
 */ 
typedef struct {
    uint64_t OrderId;
    ...
    char Padding2[2];
} MDIncrementalRefreshBookLongQtyOrderGroupT;

/*
 * Structure: M D Incremental Refresh Book Long Qty Order Groups
 */ 
typedef struct {
    GroupSize8ByteT GroupSize8Byte;
} MDIncrementalRefreshBookLongQtyOrderGroupsT;

/*
 * Structure: M D Incremental Refresh Book Long Qty Group
 */ 
typedef struct {
    int64_t MdEntryPxOptional;
    uint64_t MdEntrySizeUInt64Null;
    ...
    char Padding1[1];
} MDIncrementalRefreshBookLongQtyGroupT;

/*
 * Structure: M D Incremental Refresh Book Long Qty Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} MDIncrementalRefreshBookLongQtyGroupsT;

/*
 * Structure: Trading Sessions Group
 */ 
typedef struct {
    uint16_t TradeDate;
    uint16_t SettlDate;
...
} TradingSessionsGroupT;

/*
 * Structure: Trading Sessions Groups
 */ 
typedef struct {
    GroupSizeT GroupSize;
} TradingSessionsGroupsT;
...
typedef struct {
    ...
    uint8_t AggressorSide;
    uint8_t MdUpdateAction;
    uint32_t MdTradeEntryIDUInt32Null;
    char Padding2[2];
