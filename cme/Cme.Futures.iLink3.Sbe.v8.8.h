/*******************************************************************************
 * C Structs For Cme Futures Sbe iLink3 8.8 Binary Model
 *******************************************************************************/
...
#define ENUM_CUST_ORDER_CAPACITY_MEMBERFIRMTRADINGFORITSPROPRIETARYACCOUNT 2
#define ENUM_CUST_ORDER_CAPACITY_MEMBERTRADINGFORANOTHERMEMBERORNONMEMBER 3
...
#define ENUM_CUST_ORDER_HANDLING_INST_FCMAP_IOR_FIX 'G'
...
#define ENUM_EXEC_RESTATEMENT_REASON_CANCEL_RFC_ORDER 109
#define ENUM_EXEC_RESTATEMENT_REASON_CANCEL_UPON_CONTRACT_EXPIRATION 110
#define ENUM_EXEC_RESTATEMENT_REASON_SYSTEM_CANCEL 111
...
#define ENUM_LEG_SIDE_UNDISCLOSED 7
...
#define ENUM_MASS_STATUS_REQ_TYPE_ALL_ORDERS 7
...
#define ENUM_MASS_STATUS_TIF_GFS 99
 ...
 */ 
#define ENUM_ORD_TYPE_OPTIONAL_NO_VALUE 'zeroed'
...
/*
 * Quote Entry Open Values
 */ 
#define ENUM_QUOTE_ENTRY_OPEN_NO_VALUE 255
#define ENUM_QUOTE_ENTRY_OPEN_FALSE 0
#define ENUM_QUOTE_ENTRY_OPEN_TRUE 1
 ...
 * Rfq Side Values
 */ 
#define ENUM_RFQ_SIDE_NO_VALUE 255
...
#define ENUM_SIDE_UNDISCLOSED 7
...
#define ENUM_TEMPLATE_ID_ORDER_MASS_ACTION_REPORT 562
#define ENUM_TEMPLATE_ID_QUOTE_CANCEL_ACK 563
#define ENUM_TEMPLATE_ID_EXECUTION_REPORT_PENDING_CANCEL 564
#define ENUM_TEMPLATE_ID_EXECUTION_REPORT_PENDING_REPLACE 565

/*
 * Time In Force Values
 */ 
#define ENUM_TIME_IN_FORCE_NO_VALUE 255
...
#define ENUM_TIME_IN_FORCE_GOOD_FOR_SESSION 99
...
} ExecutionReportPendingReplaceT;

/*
 * Structure: Execution Report Pending Cancel
 */ 
typedef struct {
    uint32_t SeqNum;
    uint64_t Uuid;
    ...
    uint8_t PriorityIndicator;
    char OrigOrderUser[8];
    char CancelText[8];
} ExecutionReportPendingCancelT;
...
/*
 * Structure: Calculated Ccy Last Qty
 */ 
typedef struct {
    int64_t Mantissa;
    int8_t Exponent;
} CalculatedCcyLastQtyT;
...
/*
 * Structure: Contra Calculated Ccy Last Qty
 */ 
typedef struct {
    int64_t Mantissa;
    int8_t Exponent;
} ContraCalculatedCcyLastQtyT;

/*
 * Structure: Contra Gross Trade Amt
 */ 
typedef struct {
    int64_t Mantissa;
    int8_t Exponent;
} ContraGrossTradeAmtT;
...
typedef struct {
    ...
    uint8_t OrderEventReason;
    uint32_t OriginalOrderEventExecId;
    ContraGrossTradeAmtT ContraGrossTradeAmt;
    ContraCalculatedCcyLastQtyT ContraCalculatedCcyLastQty;
