/*******************************************************************************
 * C Structs For Cboe C1 Options Pitch DepthOfBook 2.41.29 Binary Model
 *******************************************************************************/
...
/*
 * Auction Notification Type Values
 */ 
#define ENUM_AUCTION_NOTIFICATION_TYPE_AIM 'B'
#define ENUM_AUCTION_NOTIFICATION_TYPE_SOLICITATION_AUCTION_MECHANISM 'S'
#define ENUM_AUCTION_NOTIFICATION_TYPE_STEP_UP_MECHANISM 'T'
#define ENUM_AUCTION_NOTIFICATION_TYPE_SUM_ALL_OR_NONE 'A'

/*
 * Auction Type Values
 */ 
#define ENUM_AUCTION_TYPE_GTH_OPENING 'G'
#define ENUM_AUCTION_TYPE_RTH_OPENING_AUCTION 'O'
...
#define ENUM_GTH_TRADING_STATUS_OPENING_ROTATION 'R'
...
#define ENUM_MESSAGE_TYPE_SOQ_STRIKE_RANGE_UPDATE_MESSAGE 0x9D
...
/*
 * Structure: Soq Strike Range Update Message
 */ 
typedef struct {
    uint32_t TimeOffset;
    char SoqIdentifier[20];
    uint64_t LowerStrikePrice;
    uint64_t UpperStrikePrice;
} SoqStrikeRangeUpdateMessageT;
