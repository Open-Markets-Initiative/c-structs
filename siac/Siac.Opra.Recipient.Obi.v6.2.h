/*******************************************************************************
 * C Structs For Siac Opra Obi Recipient 6.2 Binary Model
 *******************************************************************************/
 ...
 */ 
#define ENUM_PARTICIPANT_ID_AMEX 'A'
#define ENUM_PARTICIPANT_ID_BOX 'B'
#define ENUM_PARTICIPANT_ID_CBOE 'C'
#define ENUM_PARTICIPANT_ID_EMERALD 'D'
#define ENUM_PARTICIPANT_ID_EDGX 'E'
#define ENUM_PARTICIPANT_ID_GEMX 'H'
#define ENUM_PARTICIPANT_ID_ISE 'I'
#define ENUM_PARTICIPANT_ID_MRX 'J'
#define ENUM_PARTICIPANT_ID_MIAX 'M'
#define ENUM_PARTICIPANT_ID_NYSE 'N'
#define ENUM_PARTICIPANT_ID_OPRA 'O'
#define ENUM_PARTICIPANT_ID_PEARL 'P'
#define ENUM_PARTICIPANT_ID_NASD 'Q'
#define ENUM_PARTICIPANT_ID_BX 'T'
#define ENUM_PARTICIPANT_ID_MEMX 'U'
#define ENUM_PARTICIPANT_ID_C2 'W'
#define ENUM_PARTICIPANT_ID_PHLX 'X'
#define ENUM_PARTICIPANT_ID_BATS 'Z'
