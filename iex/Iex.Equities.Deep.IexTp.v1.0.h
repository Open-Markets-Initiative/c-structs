/*******************************************************************************
 * C Structs For Iex Equities IexTp Deep 1.0 Binary Model
 *******************************************************************************/
 ...
 * Event Flags Values
 */ 
#define ENUM_EVENT_FLAGS_ORDER_BOOK_IS_PROCESSING_AN_EVENT 0
#define ENUM_EVENT_FLAGS_EVENT_PROCESSING_COMPLETE 1
...
#define ENUM_MESSAGE_TYPE_PRICE_LEVEL_BUY_UPDATE_MESSAGE '8'
#define ENUM_MESSAGE_TYPE_PRICE_LEVEL_SELL_UPDATE_MESSAGE '5'
...
/*
 * Structure: Price Level Sell Update Message
 */ 
typedef struct {
    uint8_t EventFlags;
    int64_t Timestamp;
    ...
    uint32_t Size;
    int64_t Price;
} PriceLevelSellUpdateMessageT;

/*
 * Structure: Price Level Buy Update Message
 */ 
typedef struct {
    uint8_t EventFlags;
    int64_t Timestamp;
