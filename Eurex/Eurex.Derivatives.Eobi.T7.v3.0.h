...
#define ENUM_MATCH_TYPE_MATCH_TYPE_MINIMUM_VALUE = 7
...
#define ENUM_MD_ENTRY_TYPE_MD_ENTRY_TYPE_MINIMUM_VALUE = 203
...
#define ENUM_SECURITY_STATUS_SECURITY_STATUS_MINIMUM_VALUE = 9
...
#define ENUM_SECURITY_TRADING_STATUS_SECURITY_TRADING_STATUS_MINIMUM_VALUE = 211
